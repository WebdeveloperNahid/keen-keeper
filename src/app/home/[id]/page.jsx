...
import { MdOutlineNotificationsActive, MdOutlineVideoCall } from "react-icons/md";
    ...
    <div className="container mx-auto grid grid-cols-5 grid-rows-3 gap-4 my-10">
      ...
      <div className=" col-span-2 row-span-2 bg-fuchsia-200 text-center p-5 rounded-2xl">
        <div>
          ...
          <div className="flex justify-center ">
            <h2 className=" bg-red-500 w-20 rounded-2xl my-3  text-white"> {shows.status} </h2>
          </div>
          ...
          <div className="text-[#555050f5] font-semibold my-2" ><p>{shows.bio}</p></div>
          <div className="text-[#555050f5] font-semibold">Preferred: {shows.email}</div>
        </div>
      </div>
      ...
      <div className="col-span-3 row-span-1 bg-blue-200 rounded-2xl p-10 py-15">
        <div className="flex justify-between items-center ">
            ...
            <button className="bg-gray-400 px-2 py-1 rounded-[7px] font-bold ">Edit</button>
        </div>
      ...
      <div className="col-span-2 rounded-2xl row-span-1  space-y-6">
        <div className="bg-sky-200 text-center flex justify-center items-center gap-2 py-4 rounded-2xl font-semibold"> 
            <span><MdOutlineNotificationsActive /> </span> <h2>Snooze 2 weeks</h2> 
        </div>

        <div className="bg-sky-200 text-center flex justify-center items-center gap-2 py-4 rounded-2xl font-semibold"> 
            <span><FaBoxArchive /> </span> <h2>Archive</h2> 
        </div>

        <div className=" bg-sky-200 text-center flex justify-center items-center gap-2 py-4 rounded-2xl font-semibold text-red-400"> 
            <span><RiDeleteBinLine /> </span> <h2>Delete</h2> 
        </div>
      ...
      <div className="col-span-3 row-span-1 bg-blue-200 rounded-2xl p-10 py-15">
        ...
        <div className="grid grid-cols-3 gap-3 py-5 ">
          <div className="p bg-green-200 rounded-2xl text-center font-semibold ">
